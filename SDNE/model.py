...
class MNN(nn.Module):
    ...
    def forward(self, adj_batch, adj_mat, b_mat):
        t0 = F.leaky_relu(self.encode0(adj_batch))#100*1000
        t0 = F.leaky_relu(self.encode1(t0))#100*128
        embedding = t0
        t0 = F.leaky_relu(self.decode0(t0))#100*1000
        t0 = F.leaky_relu(self.decode1(t0))#100*2708
