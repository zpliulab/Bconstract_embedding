...
class split_train_test:
    ...
    def split_train_test_graph(self, testing_ratio=0.2):
        ...
        return G_train, testing_pos_edges, edge_num2, len(testing_pos_edges), np.array(nodes)
    ...
    def load(self,i):
        ...
        return test_pos_edges, train_num, test_num, labels, nodes